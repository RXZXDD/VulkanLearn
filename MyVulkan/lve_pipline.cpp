...
namespace lve {
	...
	void LvePipeline::createGraphicsPipline(const std::string& vertFilepath, const std::string& fragFilepath, const PiplineConfigInfo& configInfo) {
		...
		assert(configInfo.pipelineLayout != VK_NULL_HANDLE && "can not create graphics pipeline:: no pipelineLayout provided in configInfo");

		assert(configInfo.renderPass != VK_NULL_HANDLE && "can not create graphics pipeline:: no renderpass provided in configInfo");
	...
	void LvePipeline::defaultPipelineConfigInfo(PiplineConfigInfo& configInfo) {
