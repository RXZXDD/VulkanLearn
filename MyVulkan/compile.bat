G:\VulkanSDK\1.3.280.0\Bin\glslc.exe shaders\simple_shader.vert -o shaders\simple_shader.vert.spv
G:\VulkanSDK\1.3.280.0\Bin\glslc.exe shaders\simple_shader.frag -o shaders\simple_shader.frag.spv
