...
namespace lve {
	...
	{
		assert(!isFrameStarted && "can't call beginFrame while already in progrees");
	...
	void LveRenderer::endSwapChainRenderPass(VkCommandBuffer commandBuffer)
	{
		...
		assert(commandBuffer == getCurrentCommandBuffer() && "can't ending render pass on command buffer from a differnt frame");
